...
export const PAGES: PageDef[] = [
  // ── 전환 ──────────────────────────────────────────────
  {
    ...
    description: '미용입시학원 학원비를 한눈에 비교하세요. 헤어·메이크업·화장품학과 입시 실기, 지원 가능 대학 5초 진단, 자격증 가산점까지 2027학년도 기준 총정리. 내 조건으로 학원비 견적을 무료로 받아보세요.',
  ...
  },
  {
    ...
    description: '내신 등급과 실기 수준만 선택하면 5초 만에 지원 가능한 미용대학·미용학과를 진단합니다. 전형유형 → 희망학과 → 지역 순으로 선택하고 무료로 진단 결과를 받아보세요.',
    cta: '5초 진단 시작하기',
  ...
  },
  {
    ...
    description: '미용입시학원 학원비는 얼마일까? 헤어·메이크업·화장품 과정별 월 학원비, 기간별 총비용, 재료비·모의고사 등 추가 비용 범위를 공개합니다. 내 과정 정확한 견적도 무료로 받아보세요.',
    cta: '내 과정 정확한 견적 받기',
  ...
  // ── 실기 ──────────────────────────────────────────────
  {
    ...
    description: '미용입시 실기는 학과별로 다릅니다. 헤어(와인딩·업스타일·커트), 메이크업(아트마스크·뷰티일러스트) 실기 유형과 준비물, 채점 기준을 한 페이지에 정리했습니다.',
    cta: '내 학과 실기 준비 상담',
  ...
  },
  {
    ...
    description: '와인딩 방법을 단계별로 정리했습니다. 헤어 입시 실기에서 와인딩 과제가 어떻게 출제되는지, 시간 배분·섹션 나누기·감점 포인트까지 입시 기준으로 안내합니다.',
    cta: '내 실기 1:1 피드백 신청',
  ...
  },
  {
    ...
    description: '업스타일 입시 실기의 과제 유형과 채점 기준을 정리했습니다. 대학별 출제 경향, 시간 배분, 자주 감점되는 포인트와 연습 루틴까지 확인하세요.',
    cta: '내 실기 1:1 피드백 신청',
  ...
  },
  {
    ...
    h1: '아트마스크, 처음부터 끝까지',
    description: '아트마스크 그리는 법을 도안 선택부터 채색, 시간 배분까지 단계별로 안내합니다. 메이크업 입시 실기 핵심 과제인 아트마스크 채점 기준과 도안을 무료로 받는 방법까지.',
  ...
  },
  {
    ...
    h1: '입시 커트, 도면부터 읽는 법',
    description: '입시 커트 도면 읽는 법을 그래쥬에이션·레이어드 중심으로 정리했습니다. 헤어 마네킹 선택, 섹션·각도·가이드라인 설정, 감점 포인트까지 실기 기준으로 안내합니다.',
    cta: '내 실기 1:1 피드백 신청',
  ...
  },
  {
    ...
    description: '뷰티일러스트 준비물부터 채색 순서까지 정리했습니다. 메이크업·화장품 계열 입시 실기에서 뷰티일러스트가 평가하는 요소와 효율적인 연습 방법을 안내합니다.',
    cta: '실기 피드백 신청',
  ...
  // ── 학과 ──────────────────────────────────────────────
  {
    ...
    h1: '미용학과, 어디로 가야 할까',
    description: '미용학과·뷰티학과·뷰티디자인학과, 어디로 가야 할까? 헤어디자인·메이크업·화장품학과의 전형 방식, 실기 유무, 진로를 비교하고 내 성적으로 갈 수 있는 학과를 진단하세요.',
  ...
  },
  {
    ...
    h1: '화장품학과, 실기 없이도 갑니다',
    description: '화장품학과는 실기 없이 학생부·면접으로 지원할 수 있는 뷰티 전형입니다. 향장학과·화장품과학과·피부미용과 차이, 전국 개설 대학, 취업 진로와 자격증 가산점을 정리했습니다.',
  ...
  },
  {
    ...
    h1: '메이크업학과, 전국 어디에 있나',
    description: '메이크업학과·메이크업디자인학과 전국 대학 목록, 전형 방식(실기·학생부), 등급 범위, 실기 과제 유형을 정리했습니다. 내 성적으로 지원 가능한 대학을 무료로 진단하세요.',
    cta: '지원 가능 대학 진단',
  ...
  },
  {
    ...
    h1: '헤어디자인학과, 어디로 갈까',
    description: '헤어디자인학과·헤어디자인과 전국 대학, 전형 방식, 실기 과제(와인딩·업스타일·커트), 이용사 자격증 가산점을 정리했습니다. 지원 가능 대학 진단도 무료로 받아보세요.',
    cta: '지원 가능 대학 진단',
  ...
  // ── 대학 ──────────────────────────────────────────────
  {
    ...
    h1: '미용대학, 한눈에 비교하세요',
    description: '미용대학 전형·경쟁률·등급컷을 한 표로 비교합니다. 성신여대·서원대·부천대·한성대 등 전국 미용 관련 학과 개설 대학의 모집 방식과 실기 여부를 확인하세요.',
  ...
  },
  {
    ...
    description: '성신여대 뷰티산업학과 입시 정보를 정리했습니다. 전형 방식, 실기 여부, 최근 경쟁률 추이, 합격 준비 전략까지. 성신여대 합격 가능성을 무료로 진단받아 보세요.',
  ...
  },
  {
    ...
    description: '서원대 뷰티학과 입시 전형·모집인원·경쟁률과 준비 전략을 정리했습니다. 청주·천안권 수험생을 위한 실기·학생부 준비 팁과 합격 가능성 무료 진단.',
    cta: '서원대 합격 가능성 진단받기',
  ...
  },
  {
    ...
    description: '부천대 뷰티케어과, 한성대 뷰티디자인학과, 광주여대 미용과학과, 서경대 메이크업디자인학과, 원광대·수원여대·건국대 글로컬까지 미용대학 7곳의 전형과 실기 여부를 한 표로 비교합니다.',
    cta: '지원 가능 대학 진단',
    keywords: ['부천대 뷰티케어과', '한성대 AI뷰티디자인학과', '광주여대 미용과학과', '서경대 메이크업디자인학과', '원광대 뷰티디자인학과', '수원여대 미용예술과', '건국대 글로컬 뷰티'],
  ...
  // ── 자격증 ────────────────────────────────────────────
  {
    ...
    description: '미용입시 가산점이 되는 자격증을 대학별 반영표로 정리했습니다. 미용사(일반·메이크업·피부·네일), 이용사, 맞춤형화장품조제관리사 중 내 학과에 유리한 자격증을 확인하세요.',
    cta: '내 학과 가산점 자격증 상담',
  ...
  },
  {
    ...
    description: '이용사 자격증 필기·실기 시험 과목, 2026 시험일정, 합격률, 헤어 입시 가산점 반영 대학을 정리했습니다. 미용사(일반)와의 차이와 입시 병행 전략까지 확인하세요.',
    cta: '자격증 + 입시 동시 준비 상담',
  ...
  },
  {
    ...
    description: '맞춤형화장품조제관리사 시험일정·난이도·합격률·추천 교재를 정리했습니다. 화장품학과 지망생이 입시와 자격증을 동시에 준비하는 방법과 독학 가능 여부까지 안내합니다.',
    cta: '자격증 + 입시 동시 준비 상담',
  ...
  },
  {
    ...
    description: '메이크업 국가자격증(미용사 메이크업) 필기·실기 과목, 준비물, 2026 시험일정, 합격률을 정리했습니다. 메이크업학과 입시 가산점 반영 여부와 병행 전략까지 확인하세요.',
    cta: '자격증 + 입시 동시 준비 상담',
  ...
  // ── 진로 ──────────────────────────────────────────────
  {
    ...
    h1: '뷰티 직업, 뭐가 나한테 맞을까',
    description: '뷰티 직업별 연봉·전망을 비교합니다. 메이크업아티스트·헤어디자이너·화장품 연구원·피부관리사 되는 법, 초봉과 경력별 수입, 이 직업으로 가는 학과까지 한눈에 안내합니다.',
  ...
  // ── 실기 (확장) ───────────────────────────────────────
  {
    ...
    description: '헤어 실기 준비물과 메이크업 실기 시험 준비물을 품목·수량·비용까지 표로 정리했습니다. 마네킹 몇 개, 브러시 어떤 것부터 사야 하는지 입시 기준으로 안내합니다.',
  ...
  },
  {
    ...
    description: '헤어 포트폴리오 구성과 장수, 촬영 방법을 입시 기준으로 정리했습니다. 실기 우수자 전형과 면접에서 포트폴리오가 어떻게 쓰이는지, 감점되는 구성은 무엇인지 확인하세요.',
  ...
  },
  {
    ...
    description: '헤어 컬러링 실기의 색상표 읽는 법, 도포 순서, 시간 배분과 자주 감점되는 포인트를 정리했습니다. 레벨과 색조 개념부터 마네킹 연습 방법까지 입시 기준으로 안내합니다.',
    cta: '내 실기 1:1 피드백 신청',
  ...
  // ── 자격증 (확장) ─────────────────────────────────────
  {
    ...
    description: '미용사(피부) 자격증의 필기 과목, 실기 과제, 응시료와 시험 일정을 정리했습니다. 피부미용과·화장품 계열 입시에서 가산점으로 인정되는지와 병행 준비 전략까지 확인하세요.',
    cta: '자격증 + 입시 동시 준비 상담',
  ...
  },
  {
    ...
    description: '퍼스널컬러 자격증은 국가자격이 아닌 민간자격입니다. 등록 여부 확인법, 취득 비용과 기간, 미용입시에서 실제로 인정되는 범위와 면접 활용법을 솔직하게 정리했습니다.',
  ...
  // ── 가이드 ────────────────────────────────────────────
  {
    ...
    h1: '미용입시, 순서대로 준비하는 법',
    description: '미용입시를 언제부터 어떤 순서로 준비해야 하는지 정리했습니다. 학년별 준비 시기, 수시와 정시 선택, 면접 준비까지 처음 시작하는 학생과 학부모를 위한 가이드입니다.',
  ...
  },
  {
    ...
    description: '고1·고2·고3·N수생별로 미용입시를 언제 시작해야 하는지 정리했습니다. 실기 트랙은 최소 몇 개월이 필요한지, 늦게 시작했을 때 현실적인 대안은 무엇인지 확인하세요.',
  ...
  },
  {
    ...
    h1: '수시로 갈까, 정시로 갈까',
    description: '미용입시에서 수시와 정시 중 무엇이 유리한지 내신·실기·수능 조건별로 비교했습니다. 실기 반영 비율에 따라 지원 전략이 어떻게 달라지는지 표로 정리했습니다.',
    cta: '내 조건에 유리한 전형 진단',
  ...
  },
  {
    ...
    h1: '미용학과 면접, 뭘 물어볼까',
    description: '미용학과·화장품학과 면접에서 자주 나오는 질문과 답변 준비법을 정리했습니다. 지원 동기, 진로 계획, 전공 지식 질문에 어떻게 답해야 하는지 실제 유형별로 확인하세요.',
    cta: '면접 준비 1:1 상담 신청',
  ...
  // ── 진로 (확장) ───────────────────────────────────────
  {
    ...
    description: '메이크업 아티스트가 되는 경로를 학과 선택부터 자격증, 첫 취업, 경력별 수입까지 단계별로 정리했습니다. 웨딩·방송·광고 분야별 차이와 프리랜서 전환 시점도 함께 안내합니다.',
  ...
  },
  {
    ...
    description: '헤어디자이너가 되는 경로와 수입 구조를 정리했습니다. 인턴·디자이너 승급 구조, 기본급과 인센티브 방식, 미용사 자격증의 역할, 살롱 창업까지 현실적으로 안내합니다.',
    cta: '헤어 트랙 학과·학원 상담',
  ...
  },
  {
    ...
    description: '화장품 연구개발, 품질관리, 인허가, 브랜드 MD·마케팅 직무를 비교했습니다. 각 직무에 필요한 학과와 자격증, 초봉 수준과 커리어 경로를 화장품학과 지망생 기준으로 정리했습니다.',
    cta: '화장품 트랙 학과 상담',
  ...
  // ── 지역 ──────────────────────────────────────────────
  {
    ...
    h1: '우리 동네 미용입시학원',
    description: '지역별 미용입시학원 정보를 12개 지역으로 정리했습니다. 강남·수원·광주 등 우리 동네 미용입시학원 학원비와 실기 수업 특징을 비교하고 지역 맞춤 견적을 받아보세요.',
    cta: '우리 지역 학원비 견적 받기',
  ...
  },
  {
    ...
    description: '강남미용입시학원의 학원비 수준과 수업 방식, 통학 여건을 정리했습니다. 강남권 학원이 유리한 경우와 그렇지 않은 경우를 구분하고, 등록 전 확인할 기준을 안내합니다.',
    cta: '강남권 학원비 견적 받기',
  ...
  },
  {
    ...
    description: '수원미용입시학원의 학원비와 경기 남부 통학 여건을 정리했습니다. 수원여대 미용예술과를 비롯한 인근 지원 가능 대학과, 서울권 학원까지 다닐지 판단하는 기준을 안내합니다.',
    cta: '수원·경기 남부 학원비 견적',
  ...
  },
  {
    ...
    description: '광주미용입시학원의 학원비와 호남권 입시 여건을 정리했습니다. 광주여대 미용과학과 등 인근 대학과, 수도권 대학을 목표할 때 지역 학원으로 충분한지 판단 기준을 안내합니다.',
    cta: '광주·호남권 학원비 견적',
