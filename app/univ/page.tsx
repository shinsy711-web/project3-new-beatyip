    ...
    <PageShell path={PATH} width="wide">
      ...
      <article className="prose">
        ...
        <section aria-labelledby="sec-2">
          ...
          <p>
            같은 대학이라도 학과에 따라, 같은 학과라도 연도에 따라 이 네 가지 전형의 비중이 달라집니다. 예를 들어 어떤 대학은 학생부종합전형에서는 실기를 전혀 반영하지 않지만 실기우수자전형에서는 실기 비중이 70% 이상인 경우도 있습니다. 지원하려는 대학이 정해졌다면 <Link href="/univ/sungshin/">성신여대</Link>, <Link href="/univ/seowon/">서원대</Link> 페이지처럼 학과별 상세 페이지에서 전형별 반영 요소를 확인하세요.
          </p>
        </section>
